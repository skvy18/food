...
const restUrl= "https://back-zom.herokuapp.com/restaurantdetails";
const placeorder = "https://back-zom.herokuapp.com/placeorder";
                ...
                <div className="panel panel-info">
                    ...
                    <div className="panel-body">
                        ...
                        <div className="form-group">
                            ...
                            className="form-control" onChange={this.handleChangeRestaurent} />
                        </div>
                        <div className="form-group">
                            <label>Name</label>
